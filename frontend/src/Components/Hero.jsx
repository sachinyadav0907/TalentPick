    ...
    <div className="flex flex-col lg:flex-row items-center justify-between gap-14 min-h-[85vh]">
      ...
      <div className="w-full lg:w-1/2">
        ...
        {tokenValue.role=="jobseeker" && <div className="mt-8 flex flex-col sm:flex-row gap-4">
          ...
          <button className="rounded-xl bg-linear-to-r from-violet-600 to-blue-600 px-8 py-4 font-medium transition hover:opacity-90">
            Search
          </button>
        ...
        <div className="mt-10 flex flex-wrap gap-8">
          ...
          <div>
            <div className='flex gap-2 text-xl'><ImOffice className='text-2xl'/>
            <h2 className="text-2xl font-bold">1000+</h2></div>
            <p className="text-slate-400">Top Companies</p>
          </div>

          <div>
            <div className='flex gap-2 text-xl'><GiHandBag/>
            <h2 className="text-2xl font-bold">5000+</h2></div>
            <p className="text-slate-400">Verified Jobs</p>
          </div>

          <div>
            <div className='flex gap-2 text-xl items-center justify-center'><AiOutlineThunderbolt/>
            <h2 className="text-2xl font-bold">Quick Apply</h2></div>
